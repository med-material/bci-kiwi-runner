...
public class Logtodisk : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        logCollection.Add("Event", new List<string>());
        logCollection.Add("KiwiTrampolineOffset", new List<string>());
        ...
        if (!File.Exists(filepath))
        {
            ...
            string[] strheaders = { "DateTime", "Event", "KiwiTrampolineOffset", "Current Trial" };
